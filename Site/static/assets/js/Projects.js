...
function SelecionarAreaAtual(SelfElement) {
    if (SelfElement.getElementsByTagName("p")[0].style.backgroundColor != "#ffffff") {
        SelfElement.getElementsByTagName("p")[0].style.backgroundColor = "#ffffff";
        if (SelfElement.nextSibling) {
            SelfElement.nextSibling.getElementsByTagName("p")[0].style.backgroundColor = "#c2c2c2";
            ...
            SelfElement.previousSibling.getElementsByTagName("p")[0].style.backgroundColor = "#c2c2c2";
